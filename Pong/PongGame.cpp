...
PongGame::PongGame(std::string title, sf::Vector2u windowSize) : m_window(title, windowSize, "Resources/Keys/keys.cfg"){
	...
	m_window.GetEventManager()->AddCallback("LeftPaddle_move_up", &PongGame::LeftPaddleMove, this);
	m_window.GetEventManager()->AddCallback("LeftPaddle_move_down", &PongGame::LeftPaddleMove, this);
	m_window.GetEventManager()->AddCallback("RightPaddle_move_up", &PongGame::RightPaddleMove, this);
	m_window.GetEventManager()->AddCallback("RightPaddle_move_down", &PongGame::RightPaddleMove, this);
	//m_window.GetEventManager()->AddCallback("Debug", &PongGame::Debug, this);
...
void PongGame::RightPaddleMove(SFGE::EventDetails* l_details){
	float dt = GetElapsed();
...
void PongGame::LeftPaddleMove(SFGE::EventDetails* l_details){
	float dt = GetElapsed();
...
void PongGame::Debug(SFGE::EventDetails* l_details){

}

void PongGame::ballUpdate(){
...
void PongGame::rightPaddleUpdate(){
...
void PongGame::leftPaddleUpdate(){
